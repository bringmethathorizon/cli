exports.getAll = (connection) => {
    return new Promise (async (resolve, reject)=> {
        try {
            let rows = await connection.query('SELECT title, duration, genre_name as Genre, filmProd_name as Production, rating, country_name as Country, director_name as Director, producer_name as Producer, lang_name as Language from ayana.Movie d\n' +
            ...
            '                        left join ayana.Language l on d.lang_id=l.id' +
                '                       left join ayana.Genre g on d.genre_id=g.id;');
